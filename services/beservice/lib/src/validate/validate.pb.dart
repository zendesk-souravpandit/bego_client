...
import 'expression.pb.dart' as $5;
...
class MessageConstraints extends $pb.GeneratedMessage {
  factory MessageConstraints({
    $core.bool? disabled,
    $core.Iterable<$5.Constraint>? cel,
  }) {
    final $result = create();
    if (disabled != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MessageConstraints', package: const $pb.PackageName(_omitMessageNames ? '' : 'validate'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'disabled')
    ..pc<$5.Constraint>(3, _omitFieldNames ? '' : 'cel', $pb.PbFieldType.PM, subBuilder: $5.Constraint.create)
  ...
  ///  ```
  @$pb.TagNumber(3)
  $core.List<$5.Constraint> get cel => $_getList(1);
}
...
class OneofConstraints extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OneofConstraints', package: const $pb.PackageName(_omitMessageNames ? '' : 'validate'), createEmptyInstance: create)
...
class FieldConstraints extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FieldConstraints', package: const $pb.PackageName(_omitMessageNames ? '' : 'validate'), createEmptyInstance: create)
    ...
    ..pc<$5.Constraint>(23, _omitFieldNames ? '' : 'cel', $pb.PbFieldType.PM, subBuilder: $5.Constraint.create)
  ...
  ///  ```
  @$pb.TagNumber(23)
  $core.List<$5.Constraint> get cel => $_getList(21);
...
class DurationRules extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DurationRules', package: const $pb.PackageName(_omitMessageNames ? '' : 'validate'), createEmptyInstance: create)
    ..oo(0, [3, 4])
    ..oo(1, [5, 6])
    ..aOM<$6.Duration>(2, _omitFieldNames ? '' : 'const', subBuilder: $6.Duration.create)
    ..aOM<$6.Duration>(3, _omitFieldNames ? '' : 'lt', subBuilder: $6.Duration.create)
    ..aOM<$6.Duration>(4, _omitFieldNames ? '' : 'lte', subBuilder: $6.Duration.create)
    ..aOM<$6.Duration>(5, _omitFieldNames ? '' : 'gt', subBuilder: $6.Duration.create)
    ..aOM<$6.Duration>(6, _omitFieldNames ? '' : 'gte', subBuilder: $6.Duration.create)
    ..pc<$6.Duration>(7, _omitFieldNames ? '' : 'in', $pb.PbFieldType.PM, subBuilder: $6.Duration.create)
    ..pc<$6.Duration>(8, _omitFieldNames ? '' : 'notIn', $pb.PbFieldType.PM, subBuilder: $6.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  ```
  @$pb.TagNumber(2)
  $6.Duration get const_2 => $_getN(0);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $6.Duration ensureConst_2() => $_ensure(0);
  ...
  @$pb.TagNumber(4)
  $6.Duration ensureLte() => $_ensure(2);
  ...
  @$pb.TagNumber(6)
  $6.Duration ensureGte() => $_ensure(4);
  ...
  ///  ```
  @$pb.TagNumber(7)
  $core.List<$6.Duration> get in_7 => $_getList(5);
  ...
  ///  ```
  @$pb.TagNumber(8)
  $core.List<$6.Duration> get notIn => $_getList(6);
}
...
class TimestampRules extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TimestampRules', package: const $pb.PackageName(_omitMessageNames ? '' : 'validate'), createEmptyInstance: create)
    ..oo(0, [3, 4, 7])
    ..oo(1, [5, 6, 8])
    ..aOM<$7.Timestamp>(2, _omitFieldNames ? '' : 'const', subBuilder: $7.Timestamp.create)
    ..aOM<$7.Timestamp>(3, _omitFieldNames ? '' : 'lt', subBuilder: $7.Timestamp.create)
    ..aOM<$7.Timestamp>(4, _omitFieldNames ? '' : 'lte', subBuilder: $7.Timestamp.create)
    ..aOM<$7.Timestamp>(5, _omitFieldNames ? '' : 'gt', subBuilder: $7.Timestamp.create)
    ..aOM<$7.Timestamp>(6, _omitFieldNames ? '' : 'gte', subBuilder: $7.Timestamp.create)
    ..aOB(7, _omitFieldNames ? '' : 'ltNow')
    ..aOB(8, _omitFieldNames ? '' : 'gtNow')
    ..aOM<$6.Duration>(9, _omitFieldNames ? '' : 'within', subBuilder: $6.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  ```
  @$pb.TagNumber(2)
  $7.Timestamp get const_2 => $_getN(0);
  @$pb.TagNumber(2)
  ...
  void clearConst_2() => clearField(2);
  @$pb.TagNumber(2)
  $7.Timestamp ensureConst_2() => $_ensure(0);
  ...
  void clearLt() => clearField(3);
  @$pb.TagNumber(3)
  $7.Timestamp ensureLt() => $_ensure(1);
  ...
  void clearLte() => clearField(4);
  @$pb.TagNumber(4)
  $7.Timestamp ensureLte() => $_ensure(2);
  ...
  void clearGt() => clearField(5);
  @$pb.TagNumber(5)
  $7.Timestamp ensureGt() => $_ensure(3);
  ...
  void clearGte() => clearField(6);
  @$pb.TagNumber(6)
  $7.Timestamp ensureGte() => $_ensure(4);
  ...
  @$pb.TagNumber(9)
  $6.Duration ensureWithin() => $_ensure(7);
}
