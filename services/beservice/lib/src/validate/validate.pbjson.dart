...
final $typed_data.Uint8List messageConstraintsDescriptor = $convert.base64Decode(
    'ChJNZXNzYWdlQ29uc3RyYWludHMSHwoIZGlzYWJsZWQYASABKAhIAFIIZGlzYWJsZWSIAQESJg'
...
final $typed_data.Uint8List fieldConstraintsDescriptor = $convert.base64Decode(
    'ChBGaWVsZENvbnN0cmFpbnRzEiYKA2NlbBgXIAMoCzIULnZhbGlkYXRlLkNvbnN0cmFpbnRSA2'
...
const StringRules$json = {
  ...
  '2': [
    ...
    {'1': 'well_known_regex', '3': 24, '4': 1, '5': 14, '6': '.validate.KnownRegex', '8': {}, '9': 0, '10': 'wellKnownRegex'},
