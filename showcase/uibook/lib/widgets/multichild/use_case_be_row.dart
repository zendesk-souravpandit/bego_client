...
@widgetbook.UseCase(name: 'BeRow', path: 'widget/multichild', type: BeRow)
Widget useCaseBeRow(final BuildContext context) {
  ...
  final columnWidth = context.knobs.int.slider(label: 'Each Column Width (1-12)', initialValue: 4, min: 1, max: 12);
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('BeRow Widget Demo', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
  ...
  return Card(
    ...
    child: Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('BeRow - $demoType', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          ...
          Container(
            ...
            child: BeRow(
              ...
              children: _generateDemoContent(demoType, columnCount, columnWidth, showBorders, cardElevation),
            ),
          ),
        ],
      ),
  ...
  switch (demoType) {
    ...
    case 'Responsive Cards':
      return [
        BeColumn(
          ...
          sm: 6,
          md: 4,
          child: _buildResponsiveCard('Mobile First', 'xs:12 sm:6 md:4', Colors.blue, cardElevation),
        ),
        BeColumn(
          xs: 12,
          sm: 6,
          md: 4,
          child: _buildResponsiveCard('Tablet Ready', 'xs:12 sm:6 md:4', Colors.green, cardElevation),
        ),
        BeColumn(
          xs: 12,
          sm: 12,
          md: 4,
          child: _buildResponsiveCard('Desktop Optimized', 'xs:12 sm:12 md:4', Colors.orange, cardElevation),
        ),
      ];

    case 'Form Fields':
      return [
        BeColumn(xs: 12, md: 6, child: _buildFormField('First Name', 'Enter your first name', cardElevation)),
        BeColumn(xs: 12, md: 6, child: _buildFormField('Last Name', 'Enter your last name', cardElevation)),
        BeColumn(xs: 12, child: _buildFormField('Email Address', 'Enter your email address', cardElevation)),
      ];
    ...
    case 'Statistics':
      return [
        BeColumn(
          ...
          sm: 6,
          lg: 3,
          child: _buildStatCard('Users', '12.5K', Icons.people, Colors.blue, cardElevation),
        ),
        BeColumn(
          xs: 12,
          sm: 6,
          lg: 3,
          child: _buildStatCard('Revenue', '\$85.2K', Icons.attach_money, Colors.green, cardElevation),
        ),
        BeColumn(
          xs: 12,
          sm: 6,
          lg: 3,
          child: _buildStatCard('Orders', '1,245', Icons.shopping_cart, Colors.orange, cardElevation),
        ),
        BeColumn(
          xs: 12,
          sm: 6,
          lg: 3,
          child: _buildStatCard('Growth', '+12.5%', Icons.trending_up, Colors.purple, cardElevation),
        ),
      ];

    case 'Navigation Items':
      return [
        BeColumn(xs: 6, md: 2, child: _buildNavItem('Home', Icons.home, cardElevation)),
        BeColumn(xs: 6, md: 2, child: _buildNavItem('Products', Icons.inventory, cardElevation)),
        BeColumn(xs: 6, md: 2, child: _buildNavItem('Services', Icons.miscellaneous_services, cardElevation)),
        BeColumn(xs: 6, md: 2, child: _buildNavItem('About', Icons.info, cardElevation)),
        BeColumn(xs: 6, md: 2, child: _buildNavItem('Contact', Icons.contact_mail, cardElevation)),
        BeColumn(xs: 6, md: 2, child: _buildNavItem('Support', Icons.support, cardElevation)),
      ];
    ...
    case 'Image Gallery':
      return List.generate(
        6,
        (final index) =>
            BeColumn(xs: 12, sm: 6, md: 4, lg: 2, child: _buildGalleryItem('Image ${index + 1}', cardElevation)),
      );

    default:
      return [
        BeColumn(xs: 4, child: _buildBasicCard('Column 1', '4/12', Colors.red, showBorders, cardElevation)),
        BeColumn(xs: 4, child: _buildBasicCard('Column 2', '4/12', Colors.green, showBorders, cardElevation)),
        BeColumn(xs: 4, child: _buildBasicCard('Column 3', '4/12', Colors.blue, showBorders, cardElevation)),
      ];
  }
}
  ...
  return Card(
    child: Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Current BeRow Configuration', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _buildConfigChip('Spacing', '${spacing.toStringAsFixed(0)}px', Colors.blue),
              _buildConfigChip('Run Spacing', '${runSpacing.toStringAsFixed(0)}px', Colors.green),
              _buildConfigChip('Main Axis', mainAxisAlignment.toString().split('.').last, Colors.orange),
              _buildConfigChip('Cross Axis', crossAxisAlignment.toString().split('.').last, Colors.purple),
              _buildConfigChip('Main Size', mainAxisSize.toString().split('.').last, Colors.red),
            ],
          ),
        ],
      ),
  ...
  return Card(
    ...
    child: Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('BeRow Property Examples', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          ...
          _buildPropertyExample(
            ...
            BeRow(
              spacing: 8,
              children: [
                BeColumn(xs: 4, child: _buildExampleCard('4/12', Colors.blue.shade200)),
                BeColumn(xs: 4, child: _buildExampleCard('4/12', Colors.blue.shade200)),
                BeColumn(xs: 4, child: _buildExampleCard('4/12', Colors.blue.shade200)),
              ],
            ),
          ...
          _buildPropertyExample(
            ...
            BeRow(
              spacing: 8,
              children: [
                BeColumn(xs: 8, child: _buildExampleCard('8/12 (Main Content)', Colors.green.shade200)),
                BeColumn(xs: 4, child: _buildExampleCard('4/12 (Sidebar)', Colors.green.shade300)),
              ],
            ),
          ),
          ...
          _buildPropertyExample(
            ...
            BeRow(
              ...
              runSpacing: 12,
              children: [
                BeColumn(xs: 7, child: _buildExampleCard('7/12', Colors.orange.shade200)),
                BeColumn(xs: 7, child: _buildExampleCard('7/12 (wraps)', Colors.orange.shade300)),
                BeColumn(xs: 6, child: _buildExampleCard('6/12', Colors.orange.shade200)),
              ],
            ),
          ),
        ],
...
Widget _buildResponsiveCard(final String title, final String breakpoints, final Color color, final double elevation) {
  return Card(
    elevation: elevation,
    child: Container(
...
Widget _buildFormField(final String label, final String hint, final double elevation) {
  return Card(
    elevation: elevation,
    child: Padding(
      padding: const EdgeInsets.all(16),
...
Widget _buildNavItem(final String title, final IconData icon, final double elevation) {
  return Card(
    elevation: elevation,
    child: InkWell(
      onTap: () {},
    ...
    child: Column(
      children: [
        Container(
          ...
          child: const Center(child: Icon(Icons.image, size: 24, color: Colors.grey)),
        ),
        Padding(
