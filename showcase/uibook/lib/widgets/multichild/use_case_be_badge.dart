  ...
  return Padding(
    ...
    child: SingleChildScrollView(
      child: Column(
        ...
        children: [
          const Text('BeBadge Examples:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          ...
          Center(
            child: BeBadge(
              ...
              badge: Container(
                ...
                decoration: BoxDecoration(color: Colors.red, borderRadius: BorderRadius.circular(rounded ? 12 : 4)),
          ...
          Wrap(
            ...
            children: [
              ...
              BeBadge(
                ...
                child: _buildIconContainer(BeIcons.icon_notifications, Colors.blue),
              ),
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('All Badge Positions:', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                  const SizedBox(height: 16),
                  Wrap(
                    spacing: 16,
                    runSpacing: 16,
...
Widget _buildUpdateBadge() {
  return Container(
    ...
    child: const Center(child: Icon(Icons.download, color: Colors.white, size: 10)),
  );
}
...
Widget _buildProfileAvatar() {
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      image: const DecorationImage(image: NetworkImage('https://picsum.photos/50/50?random=1'), fit: BoxFit.cover),
    ),
  );
}
