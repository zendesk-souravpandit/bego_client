            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                            ...
                            child: InkWell(
                              onTap: () {
                                ScaffoldMessenger.of(
                                  context,
                                ).showSnackBar(const SnackBar(content: Text('BeOffset Red tapped!')));
                              },
                              child: Container(
                                width: 40,
                                height: 40,
                  ...
                  // Example: BeOffset with GestureDetector
                  BeOffset(
                    offset: Offset(offsetX * 2, offsetY * 2),
                    child: GestureDetector(
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('BeOffset tapped!')));
                      },
                      child: Container(
                        width: 40,
                        height: 40,
                  ...
                  const SizedBox(height: 24),
                  // Example: Stack with BeOffset and FAB
                  Stack(
                    children: [
                      Container(
                        width: 120,
                    ...
                    Stack(
                      children: [
                        Container(
                          ...
                          child: const Center(
                            child: Text('Button', style: TextStyle(color: Colors.white, fontSize: 12)),
                          ),
                        ),
                        Positioned(
                          top: 0,
                      ...
                      children: [
                        ...
                        BeOffset(
                          ...
                          child: Container(
                            ...
                            child: const Center(
                              child: Text('Preview', style: TextStyle(fontSize: 10, color: Colors.white)),
                            ),
                          ),
                        ),
                      ],
