...
class BeSimpleDropdown<T extends KeyValuePair> extends HookWidget {
  const BeSimpleDropdown({
    super.key,
    required this.items,
    this.onChanged,
    this.value,
          ...
          child: Column(
            children: [
              ...
              BeSimpleDropdown<User>(
                ...
                endWidgets: [const BeText("Hello")],
                onSaved: (newValue) {
                  print("Save Dropdown value");
                },
                trailingTitleWidgets: [const BackButton()],
