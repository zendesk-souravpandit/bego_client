...
MaterialColor createPrimarySwatch(final Color primary) {
  ...
  return MaterialColor(primary.toARGB32(), {
    ...
    500: primary, // Use original color directly
...
// Usage with your color:
const Color primary = BeColors.primary;
final MaterialColor primarySwatch = createPrimarySwatch(primary);
