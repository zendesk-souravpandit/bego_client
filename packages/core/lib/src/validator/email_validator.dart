...
class EmailValidator {
  ...
  static bool _isLetterOrDigit(final String c) {
  ...
  static bool _skipDomain(final String text, final bool allowTopLevelDomains, final bool allowInternational) {
  ...
  /// Checks if the given [text] should skip validation as an IPv4 literal.
  ///
  /// Returns `true` if the [text] matches the pattern of an IPv4 address literal,
  /// indicating that further email validation should bypass this value.
  /// Otherwise, returns `false`.
